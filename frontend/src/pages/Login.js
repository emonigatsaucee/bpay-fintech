          ...
          {mode !== 'forgot' && (
            <>
              ...
              <button
                ...
                className="w-full bg-white hover:bg-gray-50 text-gray-900 py-3 px-4 rounded-lg font-medium transition-all border border-gray-300 flex items-center justify-center space-x-2"
              >
